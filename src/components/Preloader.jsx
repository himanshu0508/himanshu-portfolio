...
const Preloader = ({ onFinished }) => {
 ...
 const fullText = "github.com/himanshu0508";
        ...
        >
          {showContent && (
            ...
            >
              ...
              >
                <a href="https://github.com/himanshuphogat" target="_blank" rel="noopener noreferrer" className="dark:hover:text-[#00ffdc] hover:text-cyan-600 transition-all duration-300 transform hover:scale-110">
                  <Github size={32} />
                </a>
                <a href="https://www.linkedin.com/in/himanshu-phogat-7a8a912a7/" target="_blank" rel="noopener noreferrer" className="dark:hover:text-[#00ffdc] hover:text-cyan-600 transition-all duration-300 transform hover:scale-110">
                  <Linkedin size={32} />
                </a>
                <a href="https://leetcode.com/u/_himanshuu/" target="_blank" rel="noopener noreferrer" className="dark:hover:text-[#00ffdc] hover:text-cyan-600 transition-all duration-300 transform hover:scale-110">
                  <SiLeetcode size={32} />
                </a>
              </motion.div>
            </motion.div>
