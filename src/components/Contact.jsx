  ...
  const socialLinks = [
    {
      name: 'GitHub',
      icon: <FaGithub />,
      url: 'https://github.com/himanshu0508',
    ...
    },
    {
      name: 'LinkedIn',
      icon: <FaLinkedin />,
      url: 'https://www.linkedin.com/in/himanshu-phogat-371468270/',
...
hoverColor: 'hover:shadow-blue-500/25'
  ...
  name: "LeetCode",
  icon: <SiLeetcode />,
  url: "https://leetcode.com/u/_himanshuu/",
  color: "from-[#2F2F2F] to-[#FFA116]",
  hoverColor: "hover:shadow-[#FFA116]/25"
}
  ];
              ...
              <div className="relative dark:bg-slate-900/80 bg-white backdrop-blur-xl rounded-3xl p-8 border dark:border-slate-700/50 border-slate-100 dark:shadow-none shadow-xl">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="dark:text-slate-400 text-slate-600">Want to discuss something? Send me a message!</p>
                  </div>
                </div>
